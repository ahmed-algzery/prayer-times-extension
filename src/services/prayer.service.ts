import { PrayerTimes, Coordinates as AdhanCoordinates, CalculationMethod, CalculationParameters } from 'adhan';
...
export class PrayerService {
   ...
   */
  private mapMethodToCalculationMethod(method: string): () => CalculationParameters {
   ...
   */
  public getRemainingTime(targetDate: Date, currentDate: Date = new Date()): {
    totalSeconds: number;
    minutes: number;
    seconds: number;
    formatted: string;
